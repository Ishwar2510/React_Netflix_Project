    ...
    <div className="home">
      ...
      >
        {category.map((elem, index) => {
          return (
            <div key={index}>
              <h3 style={{ color: "white", marginLeft: "85px" }}>
                {elem.title}
              </h3>
              <div style={{ display: "flex", flexDirection: "row" }}>
                <button style={{ background: "none" }} onClick={leftArrow}>
                  <ArrowBackIosNewOutlinedIcon
                    style={{ width: "30px", height: "120px", color: "white" }}
                  />
                </button>
                <div
                  style={{
                ...
                <button style={{ background: "none" }} onClick={rightArrow}>
